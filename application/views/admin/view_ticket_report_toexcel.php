...
<!-- M043 - YA - tambah recovery dan resolution notes -->
<?php
$now = date('d-m-Y');
$jam = date('H.i.s');
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Table border="1">
  ...
  <tr height="20">
    ...
    <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Ticket ID</Data></td>
    <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Online Order Number</Data></td>
    <td id="kepala" style="background-color:#F90"><Data ss:Type="String">SO Number</Data></td>
    ...
    <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Created By</Data></td>
    <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Create DateTime</Data></td>
    <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Handled By</Data></td>
    ...
    <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Recovering By</Data></td>
    <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Recovering DateTime</Data></td>
    <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Success/Failed DateTime</Data></td>
    <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Ticket Information</Data></td>
    <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Resolution Notes</Data></td>
    <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Recovery Notes</Data></td>
  </tr>
 <?php
 	$number = 0;
	foreach($hasil as $p)
 ...
 ?>
    ...
    <td id="badan" align="right"><Data ss:Type="String"><?php echo $p->code_ticket; ?></Data></td>
    <td id="badan" align="right"><Data ss:Type="String"><?php echo $p->id_pesanan; ?></Data></td>
    <td id="badan" align="right"><Data ss:Type="String"><?php echo $p->so_number; ?></Data></td>
    ...
    <td id="badan" align="right"><Data ss:Type="String"><?php echo $p->owner_name; ?></Data></td>
    ...
    <td id="badan" align="right"><Data ss:Type="String"><?php echo $p->recover_name; ?></Data></td>
    <td id="badan" align="right"><Data ss:Type="String"><?php echo ($p->recovering_datetime ? date("Y-m-d H:i:s", strtotime($p->recovering_datetime)) : ''); ?></Data></td>
    <td id="badan" align="right"><Data ss:Type="String"><?php echo ($p->recovered_datetime ? date("Y-m-d H:i:s", strtotime($p->recovered_datetime)) : ''); ?></Data></td>
    <td id="badan" align="right"><Data ss:Type="String"><?php echo preg_replace('/<[^>]*>/', '', $p->ticket_info); ?></Data></td>
    <td id="badan" align="right"><Data ss:Type="String"><?php echo preg_replace('/<[^>]*>/', '', $p->resolution_note); ?></Data></td>
    <td id="badan" align="right"><Data ss:Type="String"><?php echo preg_replace('/<[^>]*>/', '', $p->recovery_note); ?></Data></td>
