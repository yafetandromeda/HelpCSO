...
$now = date('d-m-Y');
$jam = date('H.i.s');
$namafile = "ActivityCodeReport__Tanggal(".$now.")__Jam(".$jam.").xls";
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Table border="1">
  <tr height="40">
     ...
     <tr height="20">
        ...
        <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Interaction Type</Data></td>
        ...
        <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Interaction Description</Data></td>
        ...
        <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Start DateTime</Data></td>
 ...
 ?>
    ...
    <td id="badan" align="right"><Data ss:Type="String"><?php echo $p->interaction_id; ?></Data></td>
    ...
    <td id="badan" align="right"><Data ss:Type="String"><?php echo ($p->start_datetime ? date("Y-m-d H:i:s", strtotime($p->start_datetime)) : ''); ?></Data></td>
