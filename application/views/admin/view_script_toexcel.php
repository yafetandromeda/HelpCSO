...
$now = date('d-m-Y');
$jam = date('H.i.s');
$namafile = "Script__Tanggal(".$now.")__Jam(".$jam.").xls";
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Script">
 <Table border="1">
  <tr height="40">
    	<td id="judul"><Data ss:Type="String">Script</Data></td>
     </tr>
     <tr height="20">
      ...
      <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Activity Definition</Data></td>
      ...
      <td id="kepala" style="background-color:#F90"><Data ss:Type="String">Script</Data></td>
      </tr>
 <?php
 	$number = 0;
	foreach($hasil as $p)
 ...
 ?>
    ...
    <td id="badan" align="right"><Data ss:Type="String"><?php echo $p->answer; ?></Data></td>
    </tr>
 <?php
	}
 ?>
